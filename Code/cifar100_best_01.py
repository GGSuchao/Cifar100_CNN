...
model_name = 'keras_cifar100_trained_model_best_01.h5'
...
Hist = model.fit_generator(datagen.flow(X_train, y_train, batch_size = batch_size), steps_per_epoch = X_train.shape[0] // batch_size, epochs = epochs, validation_data = (X_test, y_test), workers = 4)
...
pyplot.savefig('Best_01_acc.png')
...
pyplot.xlabel('epoch', size = 20)
pyplot.legend(['train', 'test'], loc = 'upper left', prop = {'size':15})
pyplot.savefig('Best_01_los.png')
